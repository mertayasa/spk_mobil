                                ...
                                <div class="tab-inner">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <form action="{{ route('bookingcar.store') }}" method="post"
                                                id="form-booking">
                                                @csrf
                                                <div class="row mb-md-80">
                                                    ...
                                                    <div class="{{$start_date != null && $end_date != null ? '' : 'd-none'}} col-12 px-0" id="noteAndSubmit">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="custom-checkbox">
                                                                    <input type="checkbox" name="pengambilan"
                                                                        id="checkDelivery">
                                                                    <span class="checkmark"></span> Apakah mobil perlu
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group d-none" id="alamatBox">
                                                                ...
                                                                @error('id_alamat')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @else
                                                                    <div class="invalid-feedback">Mohon isi alamat pengantaran
                                                                    </div>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @error('id_catatan')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @else
                                                                    <div class="invalid-feedback">Mohon isi catatan untuk kami
                                                                    </div>
                                                                @enderror
                                                            </div>
                                                            <button type="submit" class="btn-first btn-submit">Booking
                                                                Sekarang</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="car-grid mb-xl-30">
                                                        @include('frontend.layouts.card_car', ['item' => $mobil,
                                                    ...
                                                    <div class="need-help bx-wrapper padding-20">
                                                        ...
                                                        <ul class="custom">
                                                            <li class="text-custom-blue fs-18">
                                                                ...
                                                                <a href="tel:08123964771"
                                                                    class="text-light-dark">08123964771</a>
                                                            </li>
                                                            <li class="text-custom-blue fs-18">
                                                                <i class="fas fa-envelope"></i>
                                                                <a href="mailto:ramajayarent98@gmail.com" target="_blank"
                                                                    class="text-light-dark fs-14">ramajayarent98@gmail.com
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
...
@push('scriptplus')
    <script>
        ...
        btnAvailablity.addEventListener('click', (event) => {
            ...
            const url = event.target.getAttribute('data-url') + '/' + idMobil.value + '/' + startDate.value + '/' +
                endDate.value
