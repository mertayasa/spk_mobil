        ...
        <div class="card border-0 shadow">
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-0 mb-xl-0 d-flex align-items-center justify-content-xl-center">
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-0 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5">Pemasukan <small class="text-danger">(Booking selesai)</small></h2>
                            <h3 class="mb-1">{{ formatPrice($dashboard_data['pemasukan'])}}</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">Pemasukan <small class="text-danger">(Booking selesai)</small></h2>
