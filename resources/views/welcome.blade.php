...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('assets-front/source/bootstrap-3.3.6-dist/css/bootstrap.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('assets-front/source/font-awesome-4.5.0/css/font-awesome.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('assets-front/style/slider.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('assets-front/style/mystyle.css')}}">
	...
	<nav class="topnavbar navbar-default topnav">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand logo" href="#"><img src="assets-front/image/logo1.png" alt="logo"></a>
			</div>	 
		</div>
	...
	<div id="carousel-up" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner " role="listbox">
			<div class="item active">
				<img src="assets-front/image/oldcar.jpg" alt="oldcar">
			...
			<div class="item">
				<img src="assets-front/image/porche.jpg" alt="porche">
				<div class="carousel-caption">
					<h2>Porche</h2>
						<p>Lorem ipsum dolor sit amet, consectetur ,<br>
						sed do eiusmod tempor incididunt ut labore </p>
			...
			<div class="item">
				<img src="assets-front/image/benz.jpg" alt="benz">
				<div class="carousel-caption">
					<h2>Car</h2>
					<p>Lorem ipsum dolor sit amet, consectetur ,<br>
						sed do eiusmod tempor incididunt ut labore </p>
			...
			<div class="col-lg-6 costumcol colborder1">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img1colon">
						<img src="assets-front/image/featurporch.jpg" alt="porsche">
					</div>
			...
			<div class="col-lg-6 costumcol colborder2">
				<div class="row costumrow">
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 img2colon">
						<img src="assets-front/image/featurporch1.jpg" alt="porsche1">
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
						<div class="featurecontant">
							<h1>LOREM IPSUM</h1>
	...
	<div class="grid">
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="assets-front/image/car1.jpg" alt="car1">
							...
							<div class="simpletxt">
								...
								<p>"Lorem ipsum dolor sit amet, consectetur,<br>
	 							...
	 							<div class="wishtxt">
		 							...
		 							<p class="paragraph2">Compare <span class="icon"><img src="assets-front/image/compicon.png" alt="compicon"></span></p>
		 						</div>
							</div>
							<div class="stars2">
								<div class="glyphicon glyphicon-star"></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 ">
				<div class="txthover">
					<img src="assets-front/image/car2.jpg" alt="car2">
						<div class="txtcontent">
							<div class="stars">
								<div class="glyphicon glyphicon-star"></div>
								<div class="glyphicon glyphicon-star"></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="assets-front/image/car3.jpg" alt="car3">
						<div class="txtcontent">
							<div class="stars">
								<div class="glyphicon glyphicon-star"></div>
								<div class="glyphicon glyphicon-star"></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="assets-front/image/car4.jpg" alt="car4">
						<div class="txtcontent">
							<div class="stars">
								<div class="glyphicon glyphicon-star"></div>
								<div class="glyphicon glyphicon-star"></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="assets-front/image/car5.jpg" alt="car5">
						<div class="txtcontent">
							<div class="stars">
								<div class="glyphicon glyphicon-star"></div>
								<div class="glyphicon glyphicon-star"></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="assets-front/image/car6.jpg" alt="car6">
						<div class="txtcontent">
							<div class="stars">
								<div class="glyphicon glyphicon-star"></div>
								<div class="glyphicon glyphicon-star"></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="assets-front/image/car7.jpg" alt="car7">
						<div class="txtcontent">
							<div class="stars">
								<div class="glyphicon glyphicon-star"></div>
								<div class="glyphicon glyphicon-star"></div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="txthover">
					<img src="assets-front/image/car8.jpg" alt="car8">
						<div class="txtcontent">
							<div class="stars">
								<div class="glyphicon glyphicon-star"></div>
								<div class="glyphicon glyphicon-star"></div>
...
<!-- _______________________________News Letter ____________________-->
	<div class="newslettercontent">
		<div class="leftside">
			<img src="assets-front/image/border.png" alt="border">
			<h1>NEWSLETTER</h1>
		...
		<div class="rightside">
			<img class="newsimage" src="assets-front/image/newsletter.jpg" alt="newsletter">
	...
	<div class="bottommenu">
		...
		<span class="dotlogo">&bullet;</span><img src="assets-front/image/collectionlogo1.png" alt="logo1"><span class="dotlogo">&bullet;;</span>
		</div>
		...
		<p>"Lorem ipsum dolor sit amet, consectetur,  sed do eiusmod tempor incididunt <br>
		 ...
		 <img src="assets-front/image/line.png" alt="line"> <br>
...
<script type="text/javascript" src="{{asset('assets-front/source/bootstrap-3.3.6-dist/js/jquery.js')}}"></script>
<script type="text/javascript" src="{{asset('assets-front/source/js/isotope.js')}}"></script>
<script type="text/javascript" src="{{asset('assets-front/source/js/myscript.js')}}"></script> 
<script type="text/javascript" src="{{asset('assets-front/source/bootstrap-3.3.6-dist/js/jquery.1.11.js')}}"></script>
<script type="text/javascript" src="{{asset('assets-front/source/bootstrap-3.3.6-dist/js/bootstrap.js')}}"></script>
    </body>
</html>
